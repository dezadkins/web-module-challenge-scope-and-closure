...
Closures are the ability for a child function or an inner function
to access variable from a higher level scope even after the function/ variables has been called or
closed/ terminated
